...
{
    public partial class FROM_KULLANCI_DUZENLE : Form
    {
        public int ID;
        public FROM_KULLANCI_DUZENLE ()
        {
            InitializeComponent();
        }
        ...
        private void ADD_YENİ_OGRENCI_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    BL.CLASS_KULLANCILAR BL_KULLANCI_DUZENLE = new BL.CLASS_KULLANCILAR();
                    BL_KULLANCI_DUZENLE.update(txt_kullanci_tum_ad.Text, txt_kullanci_ad.Text, txt_ogrenci_sifre.Text,txt_Yetkiler.Text, ID);
